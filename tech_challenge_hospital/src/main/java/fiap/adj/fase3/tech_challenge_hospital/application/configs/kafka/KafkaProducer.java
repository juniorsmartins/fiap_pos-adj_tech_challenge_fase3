...
public final class KafkaProducer {
    ...
    public ConsultaDto enviarEventoConsulta(ConsultaDto consultaDto, MotivoEnum motivo) {
    ...
    private MensagemKafka embalarEventoConsulta(ConsultaDto dto, MotivoEnum motivo) {
